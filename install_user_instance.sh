...
# ====================================================================
# PERUBAHAN UTAMA: Menerima argumen untuk nama pengguna dan port
# ====================================================================
INSTANCE_USERNAME=$1
INSTANCE_PORT=$2
...
# ====================================================================
# PERUBAHAN UTAMA: Direktori instalasi dan nama layanan yang unik
# ====================================================================
...
# Catatan: Dependensi ini diinstal secara global. Anda hanya perlu menjalankannya sekali
# jika Anda yakin sudah terinstal, Anda bisa menghapus baris ini untuk instalasi instans berikutnya.
print_status "Memastikan dependensi dasar terinstal (ini mungkin butuh waktu)..."
...
# 2. Clone repository ke direktori unik untuk instans ini
...
# Catatan: Karena modifikasi di app.py, direktori ini akan dibuat otomatis saat app berjalan.
# Namun, membuat 'static' dan 'templates' di sini memastikan file-file tersebut ada dari awal.
...
# 9. Buat systemd service unik untuk instans ini
...
echo "  ✅ Sistem Migrasi Seamless (data instans ini)"
echo "  ✅ Recovery Otomatis (untuk instans ini)"
echo "  ✅ Domain Support dengan SSL (via panel admin instans ini)"
echo "  ✅ Nginx Reverse Proxy (global, dikonfigurasi via panel admin instans ini)"
echo ""
...
echo "  Lihat log recovery: journalctl -u ${SERVICE_NAME} -f | grep RECOVERY"
echo "  Lihat log domain: journalctl -u ${SERVICE_NAME} -f | grep DOMAIN"
echo ""
print_status "Direktori instalasi: ${INSTANCE_DIR}"
echo ""
